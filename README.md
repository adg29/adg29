...
3. [When this is a computer](https://github.com/adg29/named-computers/blob/main/docs/ADR-001-when-this-is-a-computer.md) — the judgment: function vs queue vs row vs named computer.
